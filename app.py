...
ADMIN_CLAVE = "EMVac1997-"  # Puedes cambiar esta clave por algo más seguro

# --- Cargar el DataFrame en memoria ---
...
# --- Si es administrador, permitir agregar apps ---
if es_admin:
...
# --- Mostrar las aplicaciones registradas ---
